...
async function main() {
  ...
  const echoTool = await prisma.tool.upsert({
    ...
    create: {
      name: "echo",
      description:
        "A simple echo tool that returns the input message. Useful for testing tool execution.",
      enabled: true,
      schema: {
        type: "object",
        properties: {
  ...
  const webSearchTool = await prisma.tool.upsert({
    ...
    update: {
      description:
        "Search the web for information using DuckDuckGo. Returns relevant search results. Set fetch_top_result=true to also fetch and read the content of the top result URL.",
      schema: {
        type: "object",
        properties: {
          query: {
          ...
          fetch_top_result: {
            type: "boolean",
            description:
              "If true, fetch and extract readable text from the top search result URL (default: false)",
            default: false,
          },
        },
        required: ["query"],
  ...
  const httpRequestToolSchema = {
    ...
    properties: {
      ...
      url: {
        type: "string",
        description:
          "Full URL for custom requests (use this OR api_id, not both)",
      },
      method: {
        type: "string",
      ...
      timeout: {
        type: "number",
        description:
          "Request timeout in milliseconds (default: 10000, max: 30000)",
        default: 10000,
        minimum: 1000,
        maximum: 30000,
      },
  ...
  const httpRequestTool = await prisma.tool.upsert({
    ...
    update: {
      schema: httpRequestToolSchema,
      description: httpRequestToolData.description,
    },
      ...
      schema: {
        ...
        properties: {
          ...
          path: {
            type: "string",
            description:
              'Dot-notation path, e.g. "results[0].name" or "items[*].url"',
          },
          default_value: {
      ...
      schema: {
        ...
        properties: {
          ...
          pattern: {
            type: "string",
            description:
              'JavaScript regex pattern without delimiters, e.g. "[\\\\w.]+@[\\\\w.]+\\\\.[a-z]+"',
          },
          flags: {
            type: "string",
            description:
              'Regex flags: g (global), i (case-insensitive), m (multiline), s (dot-all) — default: "g"',
            default: "g",
          },
          operation: {
            type: "string",
          ...
          replacement: {
            type: "string",
            description:
              "Replacement string for the replace operation (supports $1, $2, $<name> backreferences)",
          },
        },
      ...
      schema: {
        ...
        properties: {
          query: {
            type: "string",
            description:
              'Semantic search query to find relevant memories (e.g. "user food preferences", "previous project names")',
          },
          limit: {
            type: "number",
            description:
              "Maximum number of memories to return (default: 5, max: 10)",
            default: 5,
            minimum: 1,
            maximum: 10,
          },
      ...
      schema: {
        ...
        properties: {
          path: {
            type: "string",
            description:
              'Absolute or relative path to the file to write. Parameter name is "path" (not "file_path" or "filename").',
          },
          content: {
            type: "string",
            description:
              'The full text content to write to the file. Parameter name is "content" (not "text", "code", or "body").',
          },
          create_dirs: {
            type: "boolean",
            description:
      ...
      schema: {
        ...
        properties: {
          path: {
            type: "string",
            description:
              "Absolute or relative path to the file or directory to delete",
          },
          recursive: {
            type: "boolean",
            description:
      ...
      schema: {
        ...
        properties: {
          source: {
            type: "string",
            description:
              "Absolute or relative path to the file or directory to move",
          },
          destination: {
            type: "string",
      ...
      schema: {
        ...
        properties: {
          ...
          timeout_ms: {
            type: "number",
            description:
              "Optional wall-clock timeout in milliseconds (default 10000, max 60000)",
          },
        },
        required: ["code"],
      },
    ...
    create: {
      ...
      schema: {
        ...
        properties: {
          key: {
            type: "string",
            description: 'Identifier for the note (e.g. "plan", "findings")',
          },
    ...
    create: {
      ...
      schema: {
        ...
        properties: {
          key: {
            type: "string",
            description: "Note identifier to read; omit to list all keys",
          },
        },
        required: [],
      },
    ...
    create: {
      ...
      schema: {
        ...
        properties: {
          goal: {
            type: "string",
            description: "The sub-task goal for the child agent to accomplish",
          },
          context: {
            type: "string",
            description:
              "Optional supporting context to pass to the child agent",
          },
        },
        required: ["goal"],
      },
