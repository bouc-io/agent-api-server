...
export class AnthropicClient implements LLMClient {
    ...
    async chat(messages: LLMMessage[], options?: LLMChatOptions): Promise<LLMResponse> {
        ...
        log.debug({ model: this.config.model, messageCount: chatMessages.length }, 'AnthropicClient: sending chat');
        ...
        return {
            ...
            finish_reason: (stopReason === 'tool_use' ? 'tool_calls' : 'stop') as LLMResponse['finish_reason'],
            usage: {
