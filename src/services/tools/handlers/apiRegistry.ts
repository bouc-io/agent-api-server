...
export const API_REGISTRY: Record<string, PreConfiguredAPI> = {
  open_meteo_weather: {
    ...
    description:
      "Free weather forecasts and current conditions worldwide. Provides temperature, precipitation, wind, and more.",
  ...
  open_meteo_geocoding: {
    ...
    description:
      "Free geocoding service to convert location names to coordinates. Search for cities, regions, and countries.",
 ...
 */
export function getPreConfiguredAPI(
  apiId: string,
): PreConfiguredAPI | undefined {
